...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="text-white text-base font-semibold pt-3">
        ...
        <a href="{{route('siswa')}}" class="flex items-center text-white opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
            <i class="fas fa-sticky-note mr-3"></i>
           Biodata Siswa
        </a>
        <a href="{{route('mapel')}}" class="flex items-center text-white py-4 pl-6 nav-item">
            <i class="fa fa-book mr-3" aria-hidden="true"></i>
            Mata Pelajaran
        </a>
        <a href="{{route('kelas')}}" class="flex items-center text-white py-4 pl-6 nav-item">
...
<div class="w-full flex flex-col h-screen overflow-y-hidden">
    ...
    <header x-data="{ isOpen: false }" class="w-full bg-sidebar py-5 px-6 sm:hidden">
        ...
        <nav :class="isOpen ? 'flex': 'hidden'" class="flex flex-col pt-4">
            ...
            <a href="{{route('siswa')}}" class="flex items-center text-white opacity-75 hover:opacity-100 py-2 pl-4 nav-item">
                <i class="fas fa-sticky-note mr-3"></i>
                Biodata Siswa
            </a>
            <a href="{{route('mapel')}}" class="flex items-center  text-white py-2 pl-4 nav-item">
                <i class="fa fa-book mr-3" aria-hidden="true"></i>
                Mata Pelajaran
            </a>
            <a href="{{route('kelas')}}" class="flex items-center  text-white py-2 pl-4 nav-item">
                <i class="fa fa-building mr-3" aria-hidden="true"></i>
                Kelas
            </a>
